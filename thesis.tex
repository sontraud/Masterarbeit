...
\newcommand{\MPns}{\texttt{MP-PIC}}
\newcommand{\DP}{\texttt{DPMFoam }}
\newcommand{\DPns}{\texttt{DPMFoam}}
\newcommand{\OF}{\texttt{OpenFOAM }}
\newcommand{\OFns}{\texttt{OpenFOAM}}
\newcommand{\PIMP}{\texttt{PIMPLE }}
\newcommand{\PIMPns}{\texttt{PIMPLE}}
...
\myinstitute{Institute for Applied and Numerical Mathematics \\ in cooperation with the Engler-Bunte-Institut}
...
\makeatletter
\renewcommand\thesubfigure{Fig. \thefigure\alph{subfigure}} % redefine subcaption number format
...
\renewcommand{\d}{\ensuremath{D_p}} %Drag function
...
\captionsetup[subfigure]{
  font=footnotesize,      % or small
  labelfont=footnotesize, % size of "(a)" label
  skip=2pt,               % vertical gap between image and subcaption
  justification=centering,% or raggedright
  singlelinecheck=false   % don't center very short captions inside a small box
}
