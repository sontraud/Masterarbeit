...
The second damping term, called return-to-isotropy, relaxes the velocities to a Gaussian velocity distribution. The equilibrium distribution 
\begin{equation*}
...
\end{equation*}
and $g_0 (\pvf)$ is the approximation to the radial distribution function
\begin{equation*}
...
To factor in how often particles collide with one another we use the radial particle distribution function
\begin{equation*}
    g_0(\theta) = \dfrac{\pvfcp}{\pvfcp - \pvf}
\end{equation*}
