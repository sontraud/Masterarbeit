...
\begin{equation}
    \dfrac{(\pvf \rf)_i^{n+1} - (\pvf \rf)_i^n}{\Delta \tvar} + \dfrac{(\pvf \rf \uf)_{i+\frac{1}{2}}^{n+1}- \pvf \rf \uf)_{i-\frac{1}{2}}^{n+1}}{\Delta \xp} = 0,
\end{equation}
and the momentum equation
\begin{equation}
    \label{eq:discMom}
    \dfrac{(\pvf \rf \uf)_{i+\frac{1}{2}}^{n+1}- \pvf \rf \uf)_{i+\frac{1}{2}}^{n}}{\Delta \tvar} + \dfrac{(\pvf \rf \up^2)^n_{i+1}-\pvf \rf \up^2)^n_{i}}{\Delta \xp} + \dfrac{\tilde{\p}_{i+1}-\tilde{p}_i}{\Delta \xp} = - \F_{i+\frac{1}{2}}-\dfrac{((\pvf \rf)_i^n + (\pvf \rf)_{i+1}^n)\g}{2}.
\end{equation}
\Todo{Define $(\pvf\rf\uf^2)$}
...
\begin{align*}
    \sum_i \sum_p \left( \dfrac{\Np \mp}{\rp} \ifg_{i+\frac{1}{2}} ( \xpp)\right)\dfrac{\tilde{\ss}_{i+\frac{1}{2}}- \tilde{\ss}_i}{\frac{1}{\Delta \x}\sum_p \dfrac{\Np \mp}{\rp} \ifg_{i+\frac{1}{2}} ( \xpp) \Delta \x} = \sum_{i=0}^{N} \tilde{\ss}_{i+1} - \tilde{\ss}_i = \tilde{\ss}_N - \tilde{\ss}_0.
\end{align*}
