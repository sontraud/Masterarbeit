...
In the \MP method the pressure calculated and output is the kinematic pressure.
To get from the kinematic pressure to the pressure for comparison we multiply it by the fluid density of $1.2$.
...
\paragraph{Drag model \lstinline|ErgunWenYu| and isotropy model \lstinline|none|}
We start by using the \lstinline|ErgunWenYu| drag model and turn off the isotropy model.
The pressure drop is plotted in figure \ref{fig:PDEWYNone0015}. 
The relative error of the pressure drop is 


The minimum relative error for the pressure is at $\beta = 4.5$ and close pack particle volume fraction $\pvfcp = 0.7$.
In contrast the minimum relative error for the bed height is at $\beta = 5.0$ and $\pvfcp = 0.7$.
Because the relative error from the pressure drop dominates the overall lowest relative error is at $\beta = 4.5$ and $\pvfcp = 0.7$.
...
The minimum relative error for the pressure is at $\beta = 2.0$ and close pack particle volume fraction $\pvfcp = 0.65$.
In contrast the minimum relative error for the bed height is at $\beta = 5.0$ and $\pvfcp = 0.6$.
Because the relative error from the pressure drop dominates the overall lowest relative error is at $\beta = 2$ and $\pvfcp = 0.65$.
\FloatBarrier
\begin{figure}[h!]
    \centering
    \begin{subfigure}[b]{0.49 \linewidth}
...
The minimum relative error for the pressure is at $\beta = 4.5$ and close pack particle volume fraction $\pvfcp = 0.7$.
In contrast the minimum relative error for the bed height is at $\beta = 5.0$ and $\pvfcp = 0.7$.
Because the relative error from the bed height drop dominates the overall lowest relative error is at $\beta = 5.0$ and $\pvfcp = 0.68$.
...
\paragraph{Drag model \lstinline|PlessisMaliyahDrag| and isotropy model \lstinline|stochastic|}
The minimum relative error for the pressure is at $\beta = 1.5$ and close pack particle volume fraction $\pvfcp = 0.68$.
In contrast the minimum relative error for the bed height is at $\beta = 5.0$ and $\pvfcp = 0.7$.
Because the relative error from the bed height drop dominates the overall lowest relative error is at $\beta = 5.0$ and $\pvfcp = 0.7$.
...
\paragraph{Drag model \lstinline|ErgunWenYu| and isotropy model \lstinline|none|}
The minimum relative error for the pressure is at $P_s = 9.0$ and close pack particle volume fraction $\pvfcp = 0.55$.
In contrast the minimum relative error for the bed height is at $P_s = 8.0$ and $\pvfcp = 0.55$.
Because the relative error from the pressure drop dominates the overall lowest relative error is at $P_s = 9.0$ and $\pvfcp = 0.55$.
...
The minimum relative error for the pressure is at $P_s = 10.0$ and close pack particle volume fraction $\pvfcp = 0.65$.
In contrast the minimum relative error for the bed height is at $P_s = 8.0$ and $\pvfcp = 0.63$.
Because the relative error from the pressure drop dominates the overall lowest relative error is at $P_s = 10.0$ and $\pvfcp = 0.65$.
...
The minimum relative error for the pressure is at $P_s = 8.0$ and close pack particle volume fraction $\pvfcp = 0.58$.
In contrast the minimum relative error for the bed height is at $P_s = 10.0$ and $\pvfcp = 0.55$.
Because the relative error from the pressure drop dominates the overall lowest relative error is at $P_s = 8.0$ and $\pvfcp = 0.55$.
...
The minimum relative error for the pressure is at $P_s = 8.0$ and close pack particle volume fraction $\pvfcp = 0.63$.
In contrast the minimum relative error for the bed height is at $P_s = 10.0$ and $\pvfcp = 0.58$.
Because the relative error from the pressure drop dominates the overall lowest relative error is at $P_s = 10.0$ and $\pvfcp = 0.63$.
...
The minimum relative error for the pressure is at pressure constant $P_s = 10.0$ and exponent $\beta = 4.5$.
In contrast the minimum relative error for the bed height is at $P_s = 5.0$ and $\beta = 5.0$.
Because the relative error from the pressure drop dominates the overall lowest relative error is at $P_s = 5.0$ and $\beta = 4.5$.
...
The minimum relative error for the pressure is at pressure constant $P_s = 10.0$ and exponent $\beta = 2.0$.
In contrast the minimum relative error for the bed height is at $P_s = 5.0$ and $\beta = 5.0$.
Because the relative error from the pressure drop dominates the overall lowest relative error is at $P_s = 10.0$ and $\beta = 2.0$.
...
The minimum relative error for the pressure is at pressure constant $P_s = 5.0$ and exponent $\beta =4.0$.
In contrast the minimum relative error for the bed height is at $P_s = 5.0$ and $\beta = 5.0$.
Because the relative error from the pressure drop dominates the overall lowest relative error is at $P_s = 9.0$ and $\beta = 5.0$.
...
The minimum relative error for the pressure is at pressure constant $P_s = 6.0$ and exponent $\beta = 1.5$.
In contrast the minimum relative error for the bed height is at $P_s = 5.0$ and $\beta = 5.0$.
Because the relative error from the pressure drop dominates the overall lowest relative error is at $P_s = 6.0$ and $\beta = 5.0$.
...
The pressure gathered from the simulation is measured at the bottom, directly at the particles and the top of the simulation.
In the experiments the pressure is measured further below the bed.
We therefor expect the pressure to be higher in our simulation than that of the experiments.
